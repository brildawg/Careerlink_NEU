    ...
    <footer class="bg-success text-white pt-5 pb-4" id="footerSection">
      <div class="container">
        ...
        <div class="row text-center text-md-start mt-4">
          <div class="col-12">
            <h6 class="fw-bold">Developer Credentials</h6>
          </div>

          <div class="col-md-6 mb-3">
            <p><strong>System Developer:</strong><br>Mark John A. Abril</p>
            <p><strong>Email:</strong><br>markjohnabril23@gmail.com</p>
            <p><strong>LinkedIn:</strong><br>
              <a href="https://www.linkedin.com/in/mark-john-abril-0a0712275/" class="text-white fs-5" target="_blank">
          ...
          <div class="col-md-6 mb-3">
            <p><strong>Front-End Developer:</strong><br>Marc Ronniel</p>
            <p><strong>Email:</strong><br>marcronnielb.creencia@gmail.com</p>
            <p><strong>LinkedIn:</strong><br>
              <a href="https://www.linkedin.com/in/marc-ronniel-creencia-6516a3353/" class="text-white fs-5" target="_blank">
                <i class="bi bi-linkedin"></i>
              </a>
            </p>
          </div>
