...
function analyzeWithGPT($rawText) {
    ...
    // ✅ Clean and truncate input to avoid long processing times
    $rawText = preg_replace('/\s+/', ' ', $rawText);
    $rawText = substr($rawText, 0, 4000);
    ...
    $data = [
        ...
        'temperature' => 0.2,
        'max_tokens' => 800,
        // 'response_format' => 'json' // Uncomment if supported by your OpenAI plan
    ];
    ...
    try {
        ...
        error_log("GPT (Guzzle) response time: " . round($duration, 2) . "s");
