...
// JOB RECOMMENDATION FUNCTION WITH AI
function isJobRecommendedForCourse($jobTitle, $jobDesc, $userCourse, $apiKey) {
    ...
    $prompt = "Is this job fit for someone in \"$userCourse\"? Title: \"$jobTitle\". Description: \"$jobDesc\". Answer Yes or No only.";
    $data = [
        "model" => "gpt-3.5-turbo",
        "messages" => [
    ...
    try {
        ...
        $answer = strtolower($decoded['choices'][0]['message']['content'] ?? '');
...
<body>
  ...
  <div class="d-flex">
    ...
    <nav class="sidebar p-3" id="sidebar">
      ...
      <a href="#" class="nav-link" data-target="jobsSection"><i class="bi bi-briefcase"></i>Opportunities</a>
